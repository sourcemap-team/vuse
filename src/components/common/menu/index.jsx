...
const Menu = () => {
  ...
  return (
    <nav className={m.menu}>
      <div
        className={
          'relative flex justify-between lg:hidden bg-primary p-3 z-40'
        }
      >
        <NavLink to='/'>
      ...
      <div
        className={`${m.navbar} ${
          showMenu ? 'mt-10 lg:mt-0' : 'transform -translate-y-full'
        }`}
      >
        <div className={m.nav}>
        ...
        <div
          className={`${m.nav2} ${
            visible ? '' : 'lg:transform lg:-translate-y-16 lg:-z-30'
          }`}
        >
          ...
          <div className={m.devices}>
            ...
            <NavLink className={isActive} onClick={toggleMenu} to='/device-700'>
              ...
              <span className={m.new}>{t(`devices.device-4.name`)}</span>
            </NavLink>
