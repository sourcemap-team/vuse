...
import { IconDevice500, IconLogo, IconTaste } from 'src/assets/icons/index.jsx'
import device from 'src/assets/images/devices/500/device-500.png'
import m from "../device-500/device.module.scss";
        ...
        <div className={'h-full flex flex-col justify-between py-10 ps-10'}>
          <div>
            <div className={'flex items-center text-white'}>
              <IconDevice500 color={'#fff'}/>
              <p className={'uppercase line-height-1 ms-4 pt-2'}>
                VUSE<br/>
                <span className={'font-bold'}>{t('devices.device-5')}</span>
              </p>
            </div>
