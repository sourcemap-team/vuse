...
import { IconDevice5000, IconLiquid, IconLogo, IconRecharge, IconTaste } from 'src/assets/icons/index.jsx'
import device from 'src/assets/images/devices/5000/device-5000.png'
          ...
          <div>
            <div className={'flex items-center text-white'}>
              ...
              <p className={'uppercase line-height-1 ms-4 pt-2'}>
                VUSE<br/>
                <span className={'font-bold'}>{t('devices.device-1')}</span>
              </p>
            </div>
