...
import device11 from 'src/assets/images/devices/5000/device-taste-11.png'
import device12 from 'src/assets/images/devices/5000/device-taste-12.png'
...
const Device5000 = () => {
  ...
  return (
    <main className={'flex flex-col items-center'}>
      <section>
        <DeviceBanner className={'container mx-auto'} name={'PRO 5000'} tastes={5}/>
      </section>
