...
import reel1Ru from 'src/assets/images/utility/utility-poster-ru.png';
import reel1En from 'src/assets/images/utility/utility-poster-en.png';
import reel1Am from 'src/assets/images/utility/utility-poster-am.png';
...
const Utility = () => {
  ...
  const bannerToDisplay = banners[currentLanguage] || reel1Ru;

  return (
    <main
      className={'bg-gray-50 pt-10 flex flex-col items-center px-3 lg:px-0'}
    >
      <section className={'lg:w-2/3 bg-white rounded-xl mb-10 p-10'}>
        ...
        {/* <p className={'mt-4'}>{t(`utility.text5`)}</p>
